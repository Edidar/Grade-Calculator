from Search_Algorithms import BFS, DFS, Greedy, AStar_search,SpaceOfBFS,SpaceOfDFS,SpaceOfGr,SpaceOfA
...
def solvable(puzzle): #check if initial state puzzle is solvable: number of inversions should be even.
    inv_counter = inv_num(puzzle) #Here puzzle actually root 
    if (inv_counter %2 ==0):
        return True
    return False
...
if solvable(root):
    ...
    print("Space Complexity of BFS",SpaceOfBFS(),"\n") #calculate Space Complexity
    ...
    print("Space Complexity of DFS",SpaceOfDFS(),"\n")  #calculate Space Complexity
    ...
    print("Space Complexity of Gready",SpaceOfGr(),"\n") #calculate Space Complexity
    ...
    print("Space Complexity of A*",SpaceOfA(),"\n") #calculate Space Complexity
